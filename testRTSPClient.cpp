...
#pragma comment(lib,"F:\\live\\platfrom\\live555\\Debug\\liveMedia.lib")
#pragma comment(lib,"F:\\live\\platfrom\\live555\\Debug\\UsageEnvironment.lib")
#pragma comment(lib,"F:\\live\\platfrom\\live555\\Debug\\BasicUsageEnvironment.lib")
#pragma comment(lib,"F:\\live\\platfrom\\live555\\Debug\\groupsock.lib")
#include "faac.h"
...
int main(int argc, char** argv) {
  ...
  pVideo_H264_File = OpenFile("a.h264", "wb");
  pAudio_Aac_File = OpenFile("b.aac", "wb");
...
private:
  ...
  char* fStreamId;
  BYTE m_recvBuf[DUMMY_SINK_RECEIVE_BUFFER_SIZE + 4];
public:
	/************************************************************************/
	/* faac*/
...
DummySink::DummySink(UsageEnvironment& env, MediaSubsession& subsession, char const* streamId)
  ...
  /*aac初始化*/
  aac_Handle = NULL;
  nSampleRate = 8000;   // 采样率
  nChannels = 1;         // 声道数
  nPCMBitSize = 16;      // 单样本位数
  nInputSamples = 0;
  nMaxOutputBytes = 0;

  aac_Handle = faacEncOpen(nSampleRate, nChannels, &nInputSamples, &nMaxOutputBytes);
  if (aac_Handle == NULL)
  {
  ...
  pConfiguration = faacEncGetCurrentConfiguration(aac_Handle);
  ...
  pConfiguration->version = 4;
  pConfiguration->allowMidside = 1;
  pConfiguration->outputFormat = 1;
  // (2.2) Set encoding configuration
  faacEncSetConfiguration(aac_Handle, pConfiguration);
  /************************************************************************/
}
